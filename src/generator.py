...
def build_config(
    ...
    rules = [
        # CN ranges: built-in CIDR (no online download) so config stays up even
        # if GitHub geo ruleset is unreachable. Direct-connect domestic traffic.
        "IP-CIDR,1.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,2.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,4.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,5.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,10.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,14.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,25.0.0.0/8,DIRECT,no-resolve",
        ...
        "IP-CIDR,45.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,49.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,55.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,56.0.0.0/8,DIRECT,no-resolve",
        ...
        "IP-CIDR,170.0.0.0/8,DIRECT,no-resolve",
        ...
        "IP-CIDR,217.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,216.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,215.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,214.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,213.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,212.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,211.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,210.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,209.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,208.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,202.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,200.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,202.112.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,203.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,205.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,206.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,207.0.0.0/8,DIRECT,no-resolve",
        "IP-CIDR,211.1.0.0/16,DIRECT,no-resolve",
